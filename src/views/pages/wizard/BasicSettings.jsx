  ...
  return (
    visible && (
      <Grid container spacing={3}>
        {
          (
            !disabled && <Grid container justifyContent="flex-end">
              <Button
                size={'small'}
                color={'secondary'}
                variant={'contained'}
                      ...
                      <Controller
                        ...
                        render={({field}) => (
                          <RadioGroup row {...field} name='gender'>
                            <FormControlLabel value='female' defaultValue={isGender('female')} disabled={disabled}
                                              control={<Radio defaultChecked/>} label='Female'/>
                            <FormControlLabel value='male' defaultValue={isGender('male')} disabled={disabled}
                                              control={<Radio defaultChecked/>} label='Male'/>
                            <FormControlLabel value='both' defaultValue={isGender('both')} disabled={disabled}
                                              control={<Radio defaultChecked/>} label='Both'/>
                          </RadioGroup>
                        )}
                      />
        ...
        <Grid item xs={12}>
          ...
          {
            profileOpen && profileCategories && profileCategories.map((item, index) => (
              <Chip
                key={index}
